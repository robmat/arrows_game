...
private fun LogoSection(
    ...
    val logoPulse by infiniteTransition.animateFloat(
        initialValue = 1f,
        targetValue = GameConstants.HOME_LOGO_PULSE_SCALE,
        animationSpec =
            infiniteRepeatable(
                animation = tween(durationMillis = GameConstants.HOME_LOGO_PULSE_DURATION),
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        Text(
            ...
            modifier =
                Modifier
                    .homeEntryModifier(visible, staggerIndex = 0)
                    .graphicsLayer {
                        scaleX = logoPulse
                        scaleY = logoPulse
                    },
