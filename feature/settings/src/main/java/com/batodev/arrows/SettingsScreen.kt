...
fun SettingsScreen(
    ...
    SettingsDialogs(
        SettingsDialogsState(
            ...
            { showThemeDialog = it },
            currentTheme,
            { viewModel.preferences.saveTheme(it) },
            showSpeedDialog,
            { showSpeedDialog = it },
            currentSpeed,
            { viewModel.preferences.saveAnimationSpeed(it) },
        ),
    )
            ...
            SettingsScaffoldParams(
                ...
                preferencesParams =
                    PreferencesParams(
                        ...
                        onVibrationChange = viewModel.preferences::saveVibration,
                        onSoundsChange = viewModel.preferences::saveSounds,
                        onWinVideosChange = viewModel::saveWinVideosEnabled,
                        onFillBoardChange = viewModel.preferences::saveFillBoard,
